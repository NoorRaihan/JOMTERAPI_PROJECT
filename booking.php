<?php 
    ...
    $data = array(
        ...
        array($date, "MUHAMAD SAJAT" , 1, "0153647865", 'O', "Kaki saya kena buatan orang"),
        array($date, "MUHAMAD SAJAT" , 1, "0133244876", 'S', "tangan saya tk boleh gerak"),
        array($date, "MUHAMAD SAJAT" , 3, "01936458899", 'TB', "Tualng belakang saya bengkok"),
        array($date, "MUHAMAD SAJAT" , 1, "0113638896", 'TS', "buku lali saya sakit main bola"),
        array($date, "MUHAMAD SAJAT" , 2, "0123623623", 'B', "N/A"),
        array($date, "MUHAMAD SAJAT" , 1, "0145668875", 'TS', "Kaki saya bengkak main hoki"),
    );
